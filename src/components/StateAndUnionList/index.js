...
class StateAndUnionList extends Component {
      ...
      <div>
        ...
        {filteredList.length === 0 ? (
          <div className="cases-report">
            <NationalReport />
            <div className="state-union-list-container" testid="stateWiseCovidDataTable">
          ...
          <ul className="filtered-list-group" testid="searchResultsUnorderedList">
  ...
  renderLoadingView = () => (
    <div className="loader-container">
      <div className="state-list-loader-container" testid="homeRouteLoader">

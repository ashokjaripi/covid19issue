...
class SpecificState extends Component {
  ...
  renderTimelineSuccessView = () => {
    ...
    return (
      <div>
        ...
        <div className="daily-spread-trends" testid="lineChartsContainer">
  ...
  renderTimelineLoadingView = () => (
    <div className="loader-container">
      <div className="state-list-loader-container" testid="timelinesDataLoader">
        ...
        <div className="specific-state-container">
          ...
          <div>
            <div className="top-districts-container">
              ...
              <ul className="top-districts-list-container" testid="topDistrictsUnorderedList">
  ...
  renderLoadingView = () => (
    <div className="loader-container">
      <div className="state-list-loader-container" testid="stateDetailsLoader">
        <Loader type="TailSpin" color="#bf3987" height="50" width="50" />
      </div>
    </div>
  )
